package com.example.paymentdemo.generator;
...
public class MybatisPlus {
    ...
    private static final DataSourceConfig.Builder DATA_SOURCE_CONFIG = new DataSourceConfig
            .Builder("jdbc:mysql://localhost:3306/payment_demo?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC", "root", "")
        ...
        public void generator() {
            ...
            list.add("t_order_info");
            list.add("t_payment_info");
            list.add("t_product");
            list.add("t_refund_info");
...
//                        .parent(scanner.apply("请输入包名："))//父包名，默认值:com.baomidou
                                    .parent("com.example.paymentdemo")
...
//                                .formatFileName("%sBean")//格式化文件名称，生成实体的后缀，建议这样使用，生成后：UserLoginBean
                                    ...
                                    .addIgnoreColumns("id", "create_time", "update_time")//添加忽略字段
